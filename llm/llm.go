...
func New(workDir, model string, adapters, projectors []string, opts api.Options) (LLM, error) {
	...
	// rough calculation for scratch space from emperical testing
	// TODO: instead call llama.cpp's allocator functions to calculate how much memory will be allocated
	scratch := 8*int64(opts.NumBatch)*int64(opts.NumCtx)*int64(ggml.NumHead()) + 1536*1024*1024 // 1536MiB overhead
